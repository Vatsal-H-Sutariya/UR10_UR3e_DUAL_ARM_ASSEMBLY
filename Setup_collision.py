...
class RobotMover(Node):
    ...
    def pose_to_transform(self, x, y, z, roll, pitch, yaw):
        """
        Converts position and Euler angles to a 4x4 transformation matrix.
        ...
        Returns:
            4x4 numpy.ndarray representing the transformation matrix
        """
...
def main(args=None):
    ...
    if suc ==1 :
        ...
        print("collision!!!!!!!!!!!!!!")
    '''
    node.move_robot('ur10e', [0, -math.pi/2, 0, 0, math.pi/2, -math.pi/2])
    node.move_robot('ur3', [0, -math.pi/2, 0, 0, 0.0, 0.0])
